...
public class IdentityAccountTest extends TestRunner{
        ...
        public static Object[][] insertUser() throws SQLException{
            ...
            String insert1 ="INSERT INTO `ps_customer` (`id_customer`, `id_shop_group`," +
            ...
            String delete = "DELETE FROM ps_customer WHERE email="+"\"setstore@set.ua\";";
            String delete1 = "DELETE FROM ps_customer WHERE email="+"\"superstor@gmail.set\";";

            return new Object[][] {{ insert, email, password, newPassword, delete}, { insert1, email1, password1, newPassword1, delete1 }};
        }
...
//        final String newPassword = "268405";
        ...
        //ConncectDB conncectDB = new ConncectDB();
            conncectDB.DMLDataQuery(delete);// make to work
    }
}
